...
AVTool::MediaInfo* Decoder::detectMediaInfo(const QString& url)
{
    ...
    av_image_fill_arrays(pixels,pitch,buffer, dstPixFmt,
                                                imageWidth, imageHeight,1);

    SwsContext* swsCtx = sws_getCachedContext(nullptr,frame->width,frame->height,
        (enum AVPixelFormat)frame->format, imageWidth,imageHeight,dstPixFmt,
